    ...
    scenes: {
      ...
      items: {
        ...
        properties: {
          ...
          beats: {
            type: Type.ARRAY,
            description: "A list of distinct narrative beats that structure the scene. Generate 15-20 beats per scene (target: 18 beats) to capture significant story moments.",
            items: {
              type: Type.OBJECT,
              properties: {
