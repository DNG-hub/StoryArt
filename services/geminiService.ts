          ...
          beats: {
            ...
            items: {
              ...
              properties: {
                ...
                beat_duration_estimate_sec: { type: Type.NUMBER, description: "An estimated duration for this beat in seconds, typically between 15 and 30." },
...
- **VALIDATION CHECK:** Before submitting your response, count the beats in each scene. Each scene should have 25-40 beats (ideally 30-40 beats). Ensure each beat contains complete narrative content with 1-3 sentences of script text.`;
